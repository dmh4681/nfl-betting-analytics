      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    {climbers.map((team, idx) => (
                      <div key={team.team} className="flex items-center justify-between p-2 bg-green-500/10 rounded mb-2">
                  ...
                  <div>
                    ...
                    {drops.map((team, idx) => (
                      <div key={team.team} className="flex items-center justify-between p-2 bg-red-500/10 rounded mb-2">
                        <span className="text-white text-sm">{team.team}</span>
        ...
        {view === 'team' && currentTeamData && (
          <div className="space-y-6">
            ...
            {/* Team Header */}
            <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {currentTeamData.key_additions.slice(0, 5).map((addition, idx) => (
                          <div key={idx} className="flex items-center justify-between p-3 bg-green-500/10 border border-green-500/20 rounded">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {currentTeamData.key_losses.slice(0, 5).map((loss, idx) => (
                          <div key={idx} className="flex items-center justify-between p-3 bg-red-500/10 border border-red-500/20 rounded">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {Object.entries(currentTeamData.unit_impacts).map(([unit, impact]) => (
                      <div key={unit} className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                        <div className="flex items-center space-x-3">
